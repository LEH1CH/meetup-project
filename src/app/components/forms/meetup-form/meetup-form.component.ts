...
export class MeetupFormComponent implements OnInit {
  ...
  initForm() {
    ...
    this.meetupForm = new FormGroup({
      ...
      description: new FormControl<string>(this.meetup?.description || '', [
        Validators.required,
      ]),
      time: new FormControl<string>(this.meetup?.time || '', [
        Validators.required,
      ]),
      timeHours: new FormControl<string>(timeHoursMeetup || '', [
        Validators.required,
        Validators.pattern('([01]?[0-9]|2[0-3]):[0-5][0-9]'),
      ]),
      duration: new FormControl<number>(this.meetup?.duration || 30, [
        Validators.required,
        Validators.pattern('^[ 0-9]+$'),
      ]),
      location: new FormControl<string>(this.meetup?.location || '', [
        Validators.required,
      ]),
      ...
      need_to_know: new FormControl<string>(this.meetup?.need_to_know || '', [
        Validators.required,
      ]),
      will_happen: new FormControl<string>(this.meetup?.will_happen || '', [
        Validators.required,
      ]),
